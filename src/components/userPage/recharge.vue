  ...
  <div class="rechargePage">
    <flexbox orient="vertical">
      ...
      <flexbox-item :span="3/4">
          ...
          <p class="protocolP">点击确定，即表示已阅读并同意<a class="link" @click="protocolClick" style="color:rgb(141, 222, 135)">充值协议</a></p>
          <div v-transfer-dom>
...
export default {
  ...
  methods: {
    ...
    protocolClick: function () {
      ...
      this.alertTitle = '充值协议'
      this.alertContent = '充值费用只限于充电，不能退还哦~~'
      this.alertShow = true
    },
